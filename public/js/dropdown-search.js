...
/***/ "./resources/js/dropdown-search.js":
/*!*****************************************!*\
  !*** ./resources/js/dropdown-search.js ***!
  \*****************************************/
/***/ (() => {
...
var container = document.getElementById('dropdown_search');
var inputEl = document.querySelector('.search');
var datalistEl = document.querySelector('.datalist');
var movieList = document.querySelector('.movies_list');
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return fetch('api/people/search/' + searchString);
...
var loadMovies = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(personId) {
    var response, data;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return fetch('api/people/' + personId + '/movies');
  ...
  return function loadMovies(_x2) {
...
var formHandler = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(e) {
    var userInput, people, options;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            userInput = e.target.value.toLowerCase(); // if (userInput.length <= 0) {
            //     dropEl.style.height = 0
            //     return dropEl.innerHTML = ''
            // }

            _context4.next = 3;
            return loadData(userInput);
          ...
          case 3:
            ...
            people.forEach(function (person) {
              ...
              var name = decodeHtml(person.fullname);
              listEl.textContent = name;
              listEl.value = name;
              listEl.id = person.id; // if (person === userInput) {
            ...
            options.forEach(function (option) {
              option.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
                var movies;
                    ...
                    switch (_context3.prev = _context3.next) {
                      ...
                      case 5:
                        ...
                        movies.forEach(function (movie) {
                          ...
                          var movieName = decodeHtml(movie.name);
  ...
  return function formHandler(_x3) {
...
/******/ 	__webpack_require__.O(undefined, ["css/app"], () => (__webpack_require__("./resources/js/dropdown-search.js")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/app"], () => (__webpack_require__("./resources/css/app.scss")))
/******/ 	__webpack_exports__ = __webpack_require__.O(__webpack_exports__);
/******/ 	
/******/ })()
;
//# sourceMappingURL=dropdown-search.js.map